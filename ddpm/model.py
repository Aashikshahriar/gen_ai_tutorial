"""
Denoiser x_theta(x_t, t) that predicts x0_hat directly from a noisy MNIST digit
and its timestep, as trained by the algorithm in the DDPM training section.
...
class Denoiser(nn.Module):
    ...
    def forward(self, x, t):
        """x: (batch, 1, 28, 28), t: (batch,) 1-indexed timesteps -> x0_hat"""
